...
export default function SimulateurPage({ user: _user }: { user: AuthUser }) {
  ...
  return (
    <>
      <style>{CSS}</style>
      <div style={{ width: '100%', maxWidth: '100%', fontFamily: 'var(--font-sans)' }} className="sim-print-full">
        ...
        <div className="sim-no-print" style={{
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            {[
              ...
              { label: 'Taux indicatif', value: '8,50%', sub: 'Référence marché' },
        ...
        <div className="sim-grid">
          ...
          {/* ── LEFT: Inputs ────────────────────────────────────────────── */}
          <div className="sim-params" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {/* KPI row */}
            <div className="sim-kpi-row" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
              {[
            ...
            <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '14px', overflow: 'hidden' }}>
              ...
              {/* Tab bar */}
              <div className="sim-tabbar" style={{ display: 'flex', borderBottom: '1px solid var(--border)', padding: '0 20px', gap: '0', background: 'var(--card)' }}>
                {[
                ...
                <div style={{ padding: '24px 20px 16px' }}>
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 0 }}>
                      <defs>
                        <linearGradient id={`${uid}gCap`} x1="0" y1="0" x2="0" y2="1">
                          <stop offset="5%" stopColor="var(--primary)" stopOpacity={0.18} />
                          <stop offset="95%" stopColor="var(--primary)" stopOpacity={0} />
                        </linearGradient>
                        <linearGradient id={`${uid}gInt`} x1="0" y1="0" x2="0" y2="1">
                          <stop offset="5%" stopColor="var(--accent)" stopOpacity={0.18} />
                          <stop offset="95%" stopColor="var(--accent)" stopOpacity={0} />
                        </linearGradient>
                        <linearGradient id={`${uid}gCapR`} x1="0" y1="0" x2="0" y2="1">
                      ...
                      <Area type="monotone" dataKey="capitalRestant" stroke="var(--primary)" strokeWidth={2.5} fill={`url(#${uid}gCap)`} dot={false} activeDot={{ r: 4, fill: 'var(--primary)' }} />
                      <Area type="monotone" dataKey="cumulInterets" stroke="var(--accent)" strokeWidth={2.5} fill={`url(#${uid}gInt)`} dot={false} activeDot={{ r: 4, fill: 'var(--accent)' }} />
                      <Area type="monotone" dataKey="cumulCapital" stroke="var(--success)" strokeWidth={2} fill={`url(#${uid}gCapR)`} dot={false} activeDot={{ r: 4, fill: 'var(--success)' }} strokeDasharray="5 4" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              )}
            ...
            <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '13px', padding: '18px 22px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 160px), 1fr))', gap: '14px 22px' }}>
                {[
